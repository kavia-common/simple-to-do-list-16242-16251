...
function App() {
  ...
  const isScreen604 = route === '/macbook-front-label';
  ...
  // Lazily require the Figma screen only when needed
  const MacbookFrontLabelScreen = React.useMemo(() => {
    return require('./components/MacbookFrontLabelScreen/MacbookFrontLabelScreen.jsx').default;
  }, []);
      ...
      <header className="ocean-header" role="banner">
        <div className="ocean-header-inner">
          ...
          <nav aria-label="Primary" style={{ marginLeft: 'auto', display: 'flex', gap: 8 }}>
            ...
            <a
              href="#/macbook-front-label"
              className="ocean-btn ocean-btn-secondary"
              aria-label="View MacBook Front Label Screen"
              title="View MacBook Front Label Screen"
            >
              Screen 60-4
            </a>
            <button
